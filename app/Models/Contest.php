...
class Contest extends Model
{
    ...
    protected $fillable = ['station_id','title','image_path','question','option_a','option_b','option_c','correct_option','max_winners','prize','redemption_instructions','starts_at','ends_at','is_active','close_when_full','auto_notify_winners'];
